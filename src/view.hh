  ...
  public:
    ...
    class Flags
    {
      public:
        ...
        static constexpr uint32_t NAVIGATION_BLOCKED          = 1U << 3;
        static constexpr uint32_t PLAYER_COMMANDS_BLOCKED     = 1U << 4;
        static constexpr uint32_t DROP_IN_FOR_INACTIVE_VIEW   = 1U << 5;
